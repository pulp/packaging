...
Version:        3.3.0.17
Release:        3%{?dist}
# For historical reasons, this epoch is required to be 1. It was packaged for
# EL systems by us with an epoch of 1 since the official Fedora package has an
# epoch of 1. Now we must package with an epoch of 1 or this package will always
# be considered older.
Epoch:          1
...
%changelog
* Mon Jun 13 2016 Jeremy Cline <jcline@redhat.com> 3.3.0.17-3
- Clean up the spec file with newer macros
- Remove Python 3 build since we don't support Python 3
